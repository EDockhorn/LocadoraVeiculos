...
CREATE TABLE FUNCIONARIOS(
	...
	FOREIGN KEY (usuFUNC) REFERENCES USUARIOS(codUSU)
...
AS
		...
		FROM FUNCIONARIOS
		LEFT JOIN USUARIOS ON codUSU = usuFUNC
...
(nomeFUNC,enderFUNC,cepFUNC,cidadeFUNC,estadoFUNC,bairroFUNC,telefoneFUNC,datanascFUNC,rgFUNC,cpfFUNC,dataadmiss,datademiss,usuFUNC)
VALUES ('Johnny','Rua coronel Jaime Americano',11111,'São Paulo','SP','Vila São Franscisco',111,GETDATE(),111,111,GETDATE(),GETDATE(),1)
